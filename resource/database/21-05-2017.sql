...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-05-2017 a las 16:48:15
...
CREATE TABLE IF NOT EXISTS `tbclient` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=ascii AUTO_INCREMENT=425 ;
...
(2, 206400240, 'karol', 'sojo', 'fallas', '89509127', '2017-02-20', '2017-06-08', '206571D.tmp.png'),
...
(11, 303270488, 'leticia', 'castillo', 'fernandez', '87051744', '2017-04-11', '2017-05-26', '3031628.tmp.png'),
...
(47, 304350546, 'KAROL', 'CASTILLO', 'CARVAJAL', '70583168', '2017-02-27', '2017-05-25', '304A668.tmp.png'),
...
(164, 302710132, 'YAMI', 'CORTEZ ', 'VALVERDE', '88306227', '2017-03-09', '2017-05-22', '302AC68.tmp.png'),
...
(182, 303680105, 'MANUEL', 'MOLINA', 'CHAVES', '83851437', '2017-05-12', '2017-05-27', '3031218.tmp.png'),
...
(200, 106300690, 'Carolina', 'Leon', 'Quesada', '84085950', '2017-03-15', '2017-05-25', '106E56C.tmp.png'),
