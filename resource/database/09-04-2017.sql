...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-04-2017 a las 17:06:27
...
CREATE TABLE IF NOT EXISTS `tbclient` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=ascii AUTO_INCREMENT=341 ;
...
(2, 206400240, 'karol', 'sojo', 'fallas', '89509127', '2017-02-20', '2017-04-21', '206571D.tmp.png'),
(3, 301800003, 'lorena', 'solano', 'salguero', '88281017', '2017-02-24', '2017-04-24', '3016630.tmp.png'),
...
(8, 302780218, 'sonia', 'luna', 'jimenez', '86351561', '2017-03-13', '2017-04-11', '3028997.tmp.png'),
...
(11, 303270488, 'leticia', 'castillo', 'fernandez', '87051744', '2017-02-24', '2017-04-11', '3031628.tmp.png'),
(12, 303690046, 'MAURICIO', 'PICADO', 'SANDINO', '88412613', '2017-02-23', '2017-04-23', '3034EDD.tmp.png'),
...
(17, 304150077, 'STEFANY', 'RAMOS', 'LOAIZA', '88262188', '2017-02-21', '2017-04-13', '30474C7.tmp.png'),
...
(23, 304740616, 'MILENA', 'CAMACHO', 'ALVAREZ', '83736134', '2017-02-23', '2017-04-15', '304DAA5.tmp.png'),
...
(34, 304250372, 'HUGO', 'MORA', 'CHAVES', '82840204', '2017-02-27', '2017-04-27', '3049979.tmp.png'),
(35, 304860249, 'STEVEN', 'RAMIREZ', 'SARMIENTO', '25562781', '2017-03-30', '2017-04-30', '30469A7.tmp.png'),
(36, 107970480, 'YORLENY', 'TENCIO', 'ZAMORA', '60634501', '2017-02-26', '2017-04-26', '10721EE.tmp.png'),
(37, 305090155, 'Teddy', 'Avenda??o', 'Araya', '83142906', '2017-02-27', '2017-03-27', '30598F2.tmp.png'),
(38, 305160517, 'DYLAN', 'CHAVARRIA ', 'DIAZ', '83167250', '2017-02-27', '2017-04-27', '305CA97.tmp.png'),
...
(43, 304720541, 'Elias', 'Abarca', 'Hernandez', '87347525', '2017-03-20', '2017-04-20', '304DC42.tmp.png'),
(44, 115320473, 'REBECA', 'SABORIO', 'RIVAS', '83138806', '2017-02-27', '2017-03-27', '1152C46.tmp.png'),
(45, 206410079, 'RUBEN', 'RAMOS', 'ULATE', '83876631', '2017-03-28', '2017-04-13', '206C320.tmp.png'),
(46, 114680772, 'YESSICA', 'KURR', 'MENDIOLA', '88012636', '2017-03-28', '2017-04-13', '114D9BD.tmp.png'),
(47, 304350546, 'KAROL', 'CASTILLO', 'CARVAJAL', '70583168', '2017-02-27', '2017-04-14', '304A668.tmp.png'),
(48, 304630861, 'Daniel', 'Vargas', 'Guerrero', '89750225', '2017-02-27', '2017-04-27', '304A9A0.tmp.png'),
(49, 304630442, 'Styvent', 'Munoz', 'Sanabria', '89238904', '2017-03-21', '2017-04-05', '3043020.tmp.png'),
(50, 302160269, 'Juan', 'CHINCHILLA', 'CASTRO', '85004603', '2017-02-28', '2017-04-28', '302EAF6.tmp.png'),
(51, 302950334, 'Marisol', 'Bogantes', 'Rodriguez', '83764957', '2017-02-28', '2017-04-29', '302E15F.tmp.png'),
(52, 303640609, 'Hellen', 'Castro', 'w', '88258187', '2017-02-28', '2017-04-14', '3032021.tmp.png'),
...
(55, 303650930, 'WALTER', 'SOLANO', 'ALVARADO', '85178776', '2017-03-29', '2017-04-13', '303F746.tmp.png'),
(56, 303890354, 'Adrian', 'Gomez', 'Cordero', '83256548', '2017-02-28', '2017-04-28', '303F7C6.tmp.png'),
(57, 304120235, 'PAMELA', 'BADILLA', 'MORA', '88383560', '2017-02-28', '2017-04-28', '3047E00.tmp.png'),
(58, 111780969, 'MONICA', 'PASOS', 'MARTINEZ', '88869261', '2017-02-28', '2017-04-28', '1114357.tmp.png'),
(59, 304380318, 'Manuel', 'Brenes', 'Avenda??o', '88804224', '2017-02-28', '2017-04-20', '3046871.tmp.png'),
(60, 303060494, 'MARIELA', 'TORTOS', 'GONZALEZ', '89267273', '2017-03-01', '2017-05-01', '303EC1A.tmp.png'),
(61, 303930423, 'Allan ', 'Aguilar', 'Nunez', '83184863', '2017-03-01', '2017-04-20', '30393A3.tmp.png'),
(62, 304140168, 'CATALINA', 'GARCIA', 'OBANDO', '89653342', '2017-02-28', '2017-04-29', '3043472.tmp.png'),
(63, 304830804, 'Yoselin', 'Castillo', 'Carvajal', '83354736', '2017-03-27', '2017-04-11', '304CCC4.tmp.png'),
(64, 302710421, 'LEDA', 'GUERRERO', 'VARGAS', '87312424', '2017-04-01', '2017-05-01', '302EB84.tmp.png'),
(66, 303550789, 'Geizel', 'Aguilar', 'Sanabria', '87041021', '2017-03-01', '2017-04-16', '303A8E5.tmp.png'),
(67, 304160969, 'Ingrid', 'Dittel', 'Masis', '89720128', '2017-03-15', '2017-04-14', '304E3D9.tmp.png'),
(68, 303950124, 'JESSICA ', 'RUIZ', 'RODA', '84440002', '2017-03-01', '2017-04-15', '30398D3.tmp.png'),
(69, 303920336, 'MICHAEL', 'MONTENEGRO', 'SOJO', '83140583', '2017-03-01', '2017-04-15', '303A31C.tmp.png'),
(70, 303760015, 'MAURICIO', 'MARTINEZ', 'LEIVA', '87089209', '2017-03-01', '2017-04-01', '3032D0F.tmp.png'),
(71, 304260344, 'Tatiana', 'Mata', 'VonMarshall', '71104320', '2017-03-01', '2017-04-15', 'image.jpg'),
(72, 303940747, 'Yessenia', 'Cerdas', 'Garita', '63824719', '2017-03-01', '2017-04-15', '303461C.tmp.png'),
(73, 305440801, 'Yeibel', 'Mattis', 'Cerdas', '63229575', '2017-03-01', '2017-04-10', '3053F8D.tmp.png'),
(74, 303530943, 'YAHAIRA', 'BRENES', 'OROZCO', '84886081', '2017-03-02', '2017-05-02', '303E8FC.tmp.png'),
...
(84, 304370352, 'ESTEBAN', 'BONILLA', 'REDONDO', '84972913', '2017-03-02', '2017-05-02', '304AEDE.tmp.png'),
...
(89, 303840217, 'JOHANA', 'ARCE', 'GOMEZ', '87104157', '2017-03-03', '2017-05-02', '303303E.tmp.png'),
...
(93, 108190767, 'karen', 'valladares', 'jacamo', '83947817', '2017-03-03', '2017-05-03', '108C7CC.tmp.png'),
...
(96, 303580842, 'Eudalia', 'Oviedo', 'Avila', '84998553', '2017-03-03', '2017-05-02', '303811F.tmp.png'),
(97, 304910633, 'Jose', 'Moya', 'Marin', '85669296', '2017-03-03', '2017-04-03', '3045F6C.tmp.png'),
(98, 305000967, 'Felipe', 'BRENES', 'Avenda??o', '87529522', '2017-02-28', '2017-04-20', '305A293.tmp.png'),
(99, 304890201, 'Daniel', 'Brenes', 'Avenda??o', '86471689', '2017-02-28', '2017-04-20', '304A63A.tmp.png'),
(100, 303210831, 'Maykel', 'CONTRERAS', 'SANDOVAL', '89880810', '2017-03-03', '2017-05-03', '30355E3.tmp.png'),
(101, 104280466, 'JENNIFER', 'COLINDRES', 'AMADOR', '83523045', '2017-03-03', '2017-05-03', '104BE43.tmp.png'),
...
(107, 108860186, 'Ana', 'Jimenez', 'Solano', '86528232', '2017-03-03', '2017-05-02', '108170E.tmp.png'),
...
(112, 302920725, 'MARTA', 'SOLANO', 'BRENES', '89820804', '2017-03-06', '2017-04-19', '302E800.tmp.png'),
...
(117, 206280860, 'PABLO', 'RAMIREZ', 'GOMEZ', '71056065', '2017-03-06', '2017-04-26', '2067DC9.tmp.png'),
(118, 304410956, 'JUAN JOSE', 'BARBOZA ', 'NUNEZ', '86657204', '2017-03-06', '2017-05-06', '30495FD.tmp.png'),
(119, 304160455, 'DANIELA', 'ROJAS', 'SOLANO', '89826180', '2017-03-06', '2017-04-21', '3041E6D.tmp.png'),
...
(126, 304030330, 'GLORIANA', 'ALFARO', 'GONZALEZ', '89720132', '2017-03-06', '2017-04-21', '304D437.tmp.png'),
(127, 303980248, 'ROCIO', 'VARGAS', 'DIAZ', '88977161', '2017-03-06', '2017-04-21', '3035403.tmp.png'),
(128, 303970128, 'CAROLINA', 'GONZALEZ', 'BONILLA', '88843134', '2017-03-06', '2017-04-21', '3034D2.tmp.png'),
(129, 303870301, 'HELLEN', 'CAMBRONERO', 'BARRIOS', '86265600', '2017-03-06', '2017-04-06', '3039354.tmp.png'),
(130, 304480697, 'MICHAEL', 'ADAMS', 'MOYA', '86219846', '2017-03-06', '2017-05-06', 'image.jpg'),
...
(151, 302620962, 'JUAN Bosco', 'PEREIRA', 'GARITA', '83741367', '2017-03-08', '2017-05-08', '302F6D5.tmp.png'),
...
(199, 302980175, 'ERICKA', 'VON MARSHALL', 'JIMENEZ', '83576462', '2017-03-15', '2017-05-01', '302E78F.tmp.png'),
...
(222, 604570177, 'Jose', 'Blandon', 'Mendoza', '50038165', '2017-04-04', '2017-04-18', '604D953.tmp.png'),
...
(284, 305140087, 'Shanti', 'Ramakrishna', 'Loaiza', '70769395', '2017-03-26', '2017-04-09', '305371B.tmp.png'),
(285, 304530384, 'Fernando', 'CALVO', 'RIVERA', '72008263', '2017-03-27', '2017-04-27', '3049627.tmp.png'),
(286, 303090125, 'WILLIAM', 'LOPEZ', 'AGUERO', '87939554', '2017-03-27', '2017-04-11', '30398D8.tmp.png'),
(287, 304440249, 'MICHAEL', 'LOPEZ', 'AZOFEIFA', '61835722', '2017-03-27', '2017-04-11', '3041A5A.tmp.png'),
(288, 304140845, 'YIRLEY', 'LOAIZA', 'ARAYA', '60468182', '2017-03-27', '2017-04-11', '30469B2.tmp.png'),
...
(293, 303370279, 'SERGIO', 'PEREZ', 'UMA??A', '89499490', '2017-03-27', '2017-04-10', '3034E23.tmp.png'),
(294, 604090301, 'MERCEDES', 'RAMIREZ', 'BOGANTES', '62426769', '2017-03-27', '2017-04-11', '604C0CE.tmp.png'),
(295, 302180389, 'MANUEL', 'VILLALOBOS', 'UMA??A', '88666742', '2017-03-27', '2017-04-27', '3029424.tmp.png'),
(296, 402260582, 'ESTEBAN', 'ALVARADO', 'ACU??A', '89417746', '2017-03-28', '2017-04-28', '402B619.tmp.png'),
(297, 304920067, 'MARIA FERNANDA', 'OBANDO', 'NU??EZ', '87132584', '2017-03-28', '2017-04-12', '3048778.tmp.png'),
...
(305, 304330815, 'MARCELA', 'SOLANO', 'RAMIREZ', '85258025', '2017-03-15', '2017-04-15', '30493FD.tmp.png'),
(306, 303270644, 'MARIANELA', 'BRENES', 'VERGARA', '83202739', '2017-03-30', '2017-04-30', '3039E2.tmp.png'),
...
(309, 116550998, 'MICHAEL', 'SOLANO', 'SANCHEZ', '89489669', '2017-04-01', '2017-05-01', '1164A49.tmp.png'),
(310, 304610158, 'JESUS', 'VEGA', 'MELENDEZ', '62985670', '2017-04-01', '2017-05-01', '304A798.tmp.png'),
...
(317, 304770373, 'Evelyn', 'Bravo', 'Solano', '88454764', '2017-04-03', '2017-04-18', '30451D5.tmp.png'),
(318, 111250809, 'Sol', 'Garcia', 'Pacheco', '85492199', '2017-04-03', '2017-05-03', '1119B18.tmp.png'),
(319, 305300629, 'LUIS Alberto', 'GUILLEN', 'MATAMOROS', '60505096', '2017-04-03', '2017-05-03', '3051633.tmp.png'),
(320, 110940326, 'JOSE PABLO', 'GONZALEZ', 'GAZEL', '87031973', '2017-04-03', '2017-05-03', '1106770.tmp.png'),
(321, 304140720, 'ISABEL', 'SOLANO', 'SANCHEZ', '84342759', '2017-04-03', '2017-05-03', '304BC4F.tmp.png'),
(322, 304310232, 'FERNANDA', 'LEON', 'PORRAS', '86290309', '2017-04-03', '2017-05-03', '304CE97.tmp.png'),
(323, 701220871, 'ROSELLA', 'CANTILLO', 'BARBOZA', '86724316', '2017-04-03', '2017-05-03', '701592D.tmp.png'),
