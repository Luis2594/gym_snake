...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-03-2017 a las 16:03:10
...
CREATE TABLE IF NOT EXISTS `tbclient` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=ascii AUTO_INCREMENT=251 ;
...
(234, 304330641, 'ANIBAL', 'MAROTO', 'ZU??IGA', '61809852', '2017-03-17', '2017-04-17', '304FEE1.tmp.png'),
...
(244, 302090157, 'ANGELICA', 'COTO', 'ALV AREZ', '83084141', '2017-03-20', '2017-04-20', '302584D.tmp.png'),
